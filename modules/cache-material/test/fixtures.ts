...
import { EncryptedDataKey, AlgorithmSuiteIdentifier } from '@aws-crypto/material-management'
...
const encryptedDataKey1 = {
  ...
  edk: new EncryptedDataKey({
    ...
    encryptedDataKey: new Uint8Array([ 115, 117, 112, 101, 114, 32, 115, 101, 99, 114, 101, 116, 32, 107, 101, 121, 44, 32, 110, 111, 119, 32, 119, 105, 116, 104, 32, 101, 110, 99, 114, 121, 112, 116, 105, 111, 110, 33 ])
  }),
  hash: new Uint8Array([ 77, 138, 5, 121, 139, 177, 158, 207, 197, 6, 86, 176, 225, 219, 17, 12, 235, 246, 228, 224, 132, 42, 230, 70, 246, 37, 237, 230, 33, 29, 39, 194, 212, 238, 126, 96, 150, 9, 3, 1, 92, 86, 80, 70, 2, 224, 146, 138, 202, 66, 93, 30, 70, 149, 167, 23, 3, 188, 218, 146, 233, 75, 48, 137 ])
}
...
const encryptedDataKey2 = {
  ...
  edk: new EncryptedDataKey({
    ...
    encryptedDataKey: new Uint8Array([ 98, 101, 116, 116, 101, 114, 32, 115, 117, 112, 101, 114, 32, 115, 101, 99, 114, 101, 116, 32, 107, 101, 121, 44, 32, 110, 111, 119, 32, 119, 105, 116, 104, 32, 101, 110, 99, 114, 121, 112, 116, 105, 111, 110, 33 ])
  }),
  hash: new Uint8Array([ 193, 42, 195, 148, 243, 54, 161, 194, 35, 244, 192, 45, 15, 222, 20, 45, 36, 116, 66, 187, 117, 154, 224, 104, 188, 16, 209, 47, 224, 236, 73, 51, 105, 132, 145, 12, 220, 38, 127, 135, 115, 178, 189, 130, 252, 5, 29, 132, 33, 124, 116, 155, 177, 152, 194, 255, 29, 26, 220, 153, 47, 96, 252, 239 ])
}

export const encryptionContextVectors = [encryptionContextEmpty, encryptionContextFull]
